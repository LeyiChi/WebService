    ...
    public class TmpExamDict
    {
        ...
        public static DataTable GetListByStatus(DataConnection pclsCache, int Status)
        {
            ...
            try
            {
                ...
                cmd = Tmp.ExamDict.GetListByStatus(pclsCache.CacheConnectionObject);
            ...
            {
                HygeiaComUtility.WriteClientLog(HygeiaEnum.LogType.ErrorLog, "Tmp.ExamDict.GetListByStatus", "数据库操作异常！ error information : " + ex.Message + Environment.NewLine + ex.StackTrace);
                return null;
            }
            finally
            {
