...
namespace WebService.DataMethod
{
    public class CmMstTreatment
    {
        ...
        //GetTreatment 获得字典表全部信息 YDS 2014-12-01
        public static DataTable GetTreatment(DataConnection pclsCache)
        {
            ...
            try
            {
                ...
                cmd = Cm.MstTreatment.GetTreatment(pclsCache.CacheConnectionObject);
            ...
            {
                HygeiaComUtility.WriteClientLog(HygeiaEnum.LogType.ErrorLog, "CmMstTreatment.GetTreatment", "数据库操作异常！ error information : " + ex.Message + Environment.NewLine + ex.StackTrace);
                return null;
            }
            finally
            {
        ...
        //GetNameList 获得治疗目标列表or获得特殊人群列表or获得治疗措施列表 YDS 2014-12-01
        public static DataTable GetNameList(DataConnection pclsCache, string Type)
        {
            ...
            try
            {
                ...
                cmd = new CacheCommand();
                cmd = Cm.MstTreatment.GetNameList(pclsCache.CacheConnectionObject);
            ...
            {
                HygeiaComUtility.WriteClientLog(HygeiaEnum.LogType.ErrorLog, "CmMstTreatment.GetNameList", "数据库操作异常！ error information : " + ex.Message + Environment.NewLine + ex.StackTrace);
                return null;
            }
            finally
            {
